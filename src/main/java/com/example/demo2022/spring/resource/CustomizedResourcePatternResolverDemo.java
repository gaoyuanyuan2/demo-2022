...
import com.example.demo2022.spring.resource.util.ResourceUtils;
...
public class CustomizedResourcePatternResolverDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // *.java
        String currentPackagePath = "/" + System.getProperty("user.dir") + "/src/main/java/com/example/demo2022/spring/resource/";
