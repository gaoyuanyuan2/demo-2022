...
public class AnnotationMyCacheExecutionInterceptor extends MyCacheExecutionInterceptor {
     ...
     */
    public AnnotationMyCacheExecutionInterceptor(@Nullable Executor defaultExecutor) {
     ...
     *                         return type
     */
    public AnnotationMyCacheExecutionInterceptor(@Nullable Executor defaultExecutor, MyCacheUncaughtExceptionHandler exceptionHandler) {
